 ...
 * @brief Tests for temporal normalization transform parameters
 *
 * These tests verify:
 * 1. NormalizeTimeParams alignment time setting
 * 2. Value projection transforms (normalizeTimeValue, normalizeSampleTimeValue)
 *
 * Per-trial alignment uses PipelineValueStore and GatherResult::buildTrialStore().
 * See PIPELINE_VALUE_STORE.md for details.
 */
