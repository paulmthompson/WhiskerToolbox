...
TEST_CASE_METHOD(LineDataBinaryTestFixture, "LineData binary save and load through direct functions", "[LineData][Binary][IO]") {
...
TEST_CASE_METHOD(LineDataBinaryTestFixture, "LineData binary load through DataManager JSON config", "[LineData][Binary][IO][DataManager]") {
