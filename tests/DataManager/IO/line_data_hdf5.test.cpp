...
TEST_CASE_METHOD(LineDataHDF5TestFixture, "LineData HDF5 loader registration and JSON config parsing", "[LineData][HDF5][IO][DataManager]") {
...
TEST_CASE_METHOD(LineDataHDF5TestFixture, "HDF5 loader registration and format support", "[LineData][HDF5][IO]") {
