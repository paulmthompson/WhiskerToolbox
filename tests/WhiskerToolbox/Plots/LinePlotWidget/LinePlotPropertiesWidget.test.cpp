/**
 * @file LinePlotPropertiesWidget.test.cpp
 * @brief Unit tests for LinePlotPropertiesWidget
 * 
 * Tests the properties widget for LinePlotWidget, including:
...
TEST_CASE("LinePlotPropertiesWidget combo box population", "[LinePlotPropertiesWidget]")
{
...
TEST_CASE("LinePlotPropertiesWidget observer callback", "[LinePlotPropertiesWidget]")
{
    // Create QApplication if it doesn't exist (required for Qt widgets)
    int argc = 0;
    QApplication app(argc, nullptr);
...
TEST_CASE("LinePlotPropertiesWidget cleanup", "[LinePlotPropertiesWidget]")
{
    // Create QApplication if it doesn't exist (required for Qt widgets)
    int argc = 0;
    QApplication app(argc, nullptr);
