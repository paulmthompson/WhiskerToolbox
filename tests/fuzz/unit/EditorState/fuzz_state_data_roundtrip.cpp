...
void FuzzEventPlotStateDataRoundTrip(
    ...
    data.pinned = pinned;
    data.sorting_mode = static_cast<TrialSortMode>(static_cast<unsigned>(sorting_mode) % 5u);
    ...
    for (size_t i = 0; i < std::min(n, size_t{10}); ++i) {
        ...
        std::string const event_name = "event_" + std::to_string(i);
...
TEST(StateDataRoundTrip, DefaultConstructedRoundTrips) {
    ...
    {
        TestWidgetStateData const data;
    ...
    {
        DataManagerWidgetStateData const data;
        auto json = rfl::json::write(data);
    ...
    {
        TimeScrollBarStateData const data;
        auto json = rfl::json::write(data);
    ...
    {
        DataTransformWidgetStateData const data;
        auto json = rfl::json::write(data);
    ...
    {
        GroupManagementWidgetStateData const data;
        auto json = rfl::json::write(data);
    ...
    {
        DataImportWidgetStateData const data;
        auto json = rfl::json::write(data);
    ...
    {
        DataInspectorStateData const data;
        auto json = rfl::json::write(data);
