...
- **`recommendedPostEncoderModule()`** — optional model-level hint (registry key, e.g. 
  `"global_avg_pool"`). The UI pre-selects this in the Post-Encoder section when the user 
  switches models. JSON specs use `"recommended_post_encoder"`.
