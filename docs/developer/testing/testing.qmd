...
For multi-timeframe, correlated `DataManager` fixtures used in tensor/table integration tests, see [Integration test scenarios](test_scenarios.qmd). The [whisker-contact scenario](scenarios/whisker_contact.qmd) is the first documented example.
