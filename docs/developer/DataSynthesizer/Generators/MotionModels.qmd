...
`MotionParams.hpp` and reused by all moving generators. `MovingMask` uses
the same types as `MovingPoint`, getting combo-box-driven sub-forms
automatically. The planned `MovingLine` generator (Milestone 5b-ii) will
also reuse these types.
