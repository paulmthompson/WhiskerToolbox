...
|------|-------------|----------|---------|-------|
| Create new data object | `_createNewData()` via "Create New Data" button | **B** | `CreateData` ([#289](https://github.com/paulmthompson/WhiskerToolbox/issues/289)) | Calls `setData<T>()` templated on type; also sets image size for geometry types |
| Delete data object | `_deleteData()` via right-click context menu | **B** | `DeleteData` ([#289](https://github.com/paulmthompson/WhiskerToolbox/issues/289)) | Calls `deleteData(key)` |
...
| Delete selected entities | `_onDelete*Requested()` | **B** | `DeleteByEntityIds` ([#291](https://github.com/paulmthompson/WhiskerToolbox/issues/291)) | Needs entity ID set, not time range |
| Move entities to group | `_onMove*ToGroupRequested()` | **B** | `AssignToGroup` ([#292](https://github.com/paulmthompson/WhiskerToolbox/issues/292)) | Group membership change |
| Remove entities from group | `_onRemove*FromGroupRequested()` | **B** | `RemoveFromGroup` ([#292](https://github.com/paulmthompson/WhiskerToolbox/issues/292)) | Group membership change |
...
| Verb | Slot/Trigger | Category | Command | Notes |
|------|-------------|----------|---------|-------|
| Add event at current time | `_addEventButton()` | **B** | `AddEvent` ([#290](https://github.com/paulmthompson/WhiskerToolbox/issues/290)) | Single event insertion |
| Remove selected event | `_removeEventButton()` | **B** | `RemoveEvent` ([#290](https://github.com/paulmthompson/WhiskerToolbox/issues/290)) | Single event removal |
...
| Remove selected interval | `_removeIntervalButton()` | **B** | `RemoveInterval` ([#291](https://github.com/paulmthompson/WhiskerToolbox/issues/291)) | Single interval removal |
| Flip interval (swap start/end) | `_flipIntervalButton()` | **B** | `ModifyInterval` ([#291](https://github.com/paulmthompson/WhiskerToolbox/issues/291)) | In-place mutation |
| Extend interval bounds | `_extendInterval()` | **B** | `ModifyInterval` ([#291](https://github.com/paulmthompson/WhiskerToolbox/issues/291)) | Same command, different params |

#### TensorData-Specific

| Verb | Slot/Trigger | Category | Command | Notes |
|------|-------------|----------|---------|-------|
| Create tensor via designer | `_onTensorCreated()` | **B** | `CreateData` ([#289](https://github.com/paulmthompson/WhiskerToolbox/issues/289)) | May share with DataManager_Widget's CreateData |

---

## New Commands Identified

Commands discovered during the audit. Tracked in
...
param structs below are design references.

Ordered by priority (most commonly used across widgets first).

### High Priority

#### `CreateData` ([#289](https://github.com/paulmthompson/WhiskerToolbox/issues/289))
...
#### `DeleteData` ([#289](https://github.com/paulmthompson/WhiskerToolbox/issues/289))
...
#### `DeleteByEntityIds` ([#291](https://github.com/paulmthompson/WhiskerToolbox/issues/291))
...
#### `AddEvent` ([#290](https://github.com/paulmthompson/WhiskerToolbox/issues/290))
...
#### `RemoveEvent` ([#290](https://github.com/paulmthompson/WhiskerToolbox/issues/290))
...
#### `RemoveInterval` ([#291](https://github.com/paulmthompson/WhiskerToolbox/issues/291))
...
#### `ModifyInterval` ([#291](https://github.com/paulmthompson/WhiskerToolbox/issues/291))
...
#### `AssignToGroup` ([#292](https://github.com/paulmthompson/WhiskerToolbox/issues/292))
...
#### `RemoveFromGroup` ([#292](https://github.com/paulmthompson/WhiskerToolbox/issues/292))
...
Tracked in GitHub (includes command implementation and widget routing):

- [#289 — CreateData and DeleteData](https://github.com/paulmthompson/WhiskerToolbox/issues/289) (`DataManager_Widget`)
- [#290 — AddEvent and RemoveEvent](https://github.com/paulmthompson/WhiskerToolbox/issues/290) (`DigitalEventSeriesInspector`)

### Wave 2: Entity-Level Operations

Tracked in [#291 — Add Entity Commands](https://github.com/paulmthompson/WhiskerToolbox/issues/291):

- `DeleteByEntityIds` — inspector entity delete operations
- `RemoveInterval` — pairs with existing `AddInterval`
- `ModifyInterval` — flip / extend interval bounds

### Wave 3: Group Operations

Tracked in [#292 — Add Group Commands](https://github.com/paulmthompson/WhiskerToolbox/issues/292):
