...
- **[Developer Debug Panel](developer_debug_panel.qmd)** — Diagnostic infrastructure that
  accelerates development of Phases 1–2 by providing real-time visibility into lane layout,
  scales, coordinate transforms, and viewport state. Recommended to implement first.
