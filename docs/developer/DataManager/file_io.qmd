...
becomes one `DigitalEventSeries` registered as `{name}_0`, `{name}_1`, … in alphabetical filename
order. Optional `file_pattern` (glob) filters files; default extensions are `.csv` and `.txt`.
