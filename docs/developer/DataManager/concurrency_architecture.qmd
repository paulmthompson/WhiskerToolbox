...
For immediate fixes when background workers trigger observer callbacks (deferred writes, main-thread marshaling, and the widget audit checklist), see the [Observer Thread-Safety Roadmap](../Observer/observer_thread_safety_roadmap.qmd).
...
See [Batch Range Inference](../ui/DeepLearning_Widget/Inference/batch_inference.qmd).
