...
- `src/DataManager/Commands/Validation.hpp` — public API
- `src/DataManager/Commands/Validation.cpp` — implementation
- `src/DataManager/Commands/Validation.test.cpp` — unit tests
