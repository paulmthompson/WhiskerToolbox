...
- `src/DataManager/Commands/LoadData.hpp` / `.cpp`
- `src/DataManager/Commands/LoadData.test.cpp`
...
1. Map `data_type` string to `IODataType` enum via an internal lookup.
...
- [SaverRegistry Roadmap](saver_registry_roadmap.qmd) — parent roadmap (Step 3.3)
