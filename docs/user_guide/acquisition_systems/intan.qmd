...
### Creating a [TimeFrame](../../concepts/timeframe.qmd) from Digital Input
...
### Creating a [TimeFrame](../../concepts/timeframe.qmd) from Total Samples

To create a [TimeFrame](../../concepts/timeframe.qmd) based on the total number of samples in the file:
