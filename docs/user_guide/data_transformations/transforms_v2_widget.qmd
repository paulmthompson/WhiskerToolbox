...
Save and reload pipelines from a shared folder under your config directory. See [Pipeline Library](pipeline_library.qmd) for storage location, **Library...** / **Save to Library** in this widget, and **Load from Library...** in the Tensor column dialog.
