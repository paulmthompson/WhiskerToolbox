...
with plt.xkcd():
    ...
    ax1.arrow(start_point1[0], start_point1[1], end_point1[0] - start_point1[0], end_point1[1] - start_point1[1],
    ...
    ax3.add_patch(arc)
    ax3.text(0.5, 2.0, "The final angle is the difference between the\nCalculated Vector and the Reference Vector", ha='center')
