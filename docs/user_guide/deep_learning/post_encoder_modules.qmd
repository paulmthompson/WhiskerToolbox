...
The **Post-Encoder Module** section appears in the Deep Learning widget's **Dynamic Slots** panel, above the Outputs section (matching the inference pipeline: model → post-encoder → decoder).
