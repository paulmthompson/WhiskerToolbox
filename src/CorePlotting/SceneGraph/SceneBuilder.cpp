...
void SceneBuilder::buildSpatialIndexFromPending() {
...
RenderableScene SceneBuilder::build() {
    // Automatically build spatial index if we have pending discrete elements
