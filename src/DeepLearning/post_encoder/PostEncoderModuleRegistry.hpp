...
#ifndef WHISKERTOOLBOX_POST_ENCODER_MODULE_REGISTRY_HPP
#define WHISKERTOOLBOX_POST_ENCODER_MODULE_REGISTRY_HPP
...
#endif// WHISKERTOOLBOX_POST_ENCODER_MODULE_REGISTRY_HPP
