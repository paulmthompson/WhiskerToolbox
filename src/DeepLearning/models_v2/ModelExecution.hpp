...
public:
    /**
     * @brief Create with auto-detection (default) or explicit backend selection.
     *
     ...
     *
     * If BackendType is Auto, selects backend from extension:
     *   .pt  → TorchScript
     *   .pt2 → AOTInductor
    ...
    /**
     * @brief Execute the default "forward" method with ordered input tensors.
     *
...
private:
    /**
     * @brief Create the appropriate backend for the given type.
     *
