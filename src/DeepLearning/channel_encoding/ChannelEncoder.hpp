#ifndef NEURALYZER_CHANNEL_ENCODER_HPP
#define NEURALYZER_CHANNEL_ENCODER_HPP
...
/**
 * @brief How a geometry primitive is rasterized onto a tensor channel.
 */
...
/**
 * @brief User-configurable params for ImageEncoder.
 */
...
/**
 * @brief User-configurable params for Point2DEncoder.
 */
...
/**
 * @brief User-configurable params for Mask2DEncoder.
 */
...
/**
 * @brief User-configurable params for Line2DEncoder.
 */
...
/**
 * @brief Abstract base class for encoding geometry/image data into a tensor channel.
 * 
...
public:
    ...
    /**
     * @brief Human-readable name for UI / registry
     */
    [[nodiscard]] virtual std::string name() const = 0;

    /**
     * @brief Which geometry type this encoder expects (e.g. "Point2D<float>", "Mask2D")
     */
...
#endif// NEURALYZER_CHANNEL_ENCODER_HPP
