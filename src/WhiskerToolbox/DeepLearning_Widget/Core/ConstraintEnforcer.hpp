...
///
/// Phase 3.2: Extracts batch-size and decoder-consistency constraint logic
/// from DeepLearningPropertiesWidget into testable free functions that have
/// no Qt dependency and can be exercised in isolation.
...
/// Computed batch-size constraint derived from model batch mode and active
/// recurrent bindings.
///
...
/// Compute the batch-size constraint for a given model and current recurrent bindings.
///
...
/// Return the valid decoder alternative names allowed for a given post-encoder
/// module type.
///
...
///
/// @param module_type  Post-encoder module type string as returned by
