...
void OpenGLWidget::drawAnalogSeries() {
    ...
    for (auto const & [key, analog_data]: _analog_series) {
        ...
        auto Model = getAnalogModelMat(display_options.get(),
                                       key,
                                       stdDev,
                                       i,
                                       _ySpacing,
        ...
        //auto Model = getAnalogViewMat();

        auto View = getAnalogViewMat();

        auto Projection = getAnalogProjectionMat(start_time,
                                                 end_time,
                                                 _yMin,
                                                 _yMax,
                                                 _verticalPanOffset);
