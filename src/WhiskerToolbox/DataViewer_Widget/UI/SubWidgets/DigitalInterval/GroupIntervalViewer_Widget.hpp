/**
 * @file GroupIntervalViewer_Widget.hpp
 * @brief Batch property editor for a group of digital interval series in DataViewer.
 */

#ifndef GROUPINTERVALVIEWER_WIDGET_HPP
#define GROUPINTERVALVIEWER_WIDGET_HPP
...
/**
 * @brief Properties for all digital interval series in a feature-tree group selection
 *
 ...
 */
class GroupIntervalViewer_Widget : public QWidget {
    Q_OBJECT
public:
    /**
     * @brief Construct a group interval properties widget
     *
     ...
     */
    explicit GroupIntervalViewer_Widget(std::shared_ptr<DataManager> data_manager,
                                        OpenGLWidget * opengl_widget,
                                        QWidget * parent = nullptr);
    ~GroupIntervalViewer_Widget() override;
     ...
     * @param keys DataManager keys for each DigitalInterval series in the group
     */
...
#endif// GROUPINTERVALVIEWER_WIDGET_HPP
