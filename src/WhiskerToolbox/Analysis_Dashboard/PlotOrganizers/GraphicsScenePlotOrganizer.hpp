...
public:
    ...
    bool removePlot(const QString& plot_id) override;
    PlotContainer* getPlot(const QString& plot_id) const override;
    QStringList getAllPlotIds() const override;
    int getPlotCount() const override;
    void selectPlot(const QString& plot_id) override;
     ...
     */
    void setDefaultPlotPosition(const QPointF& position);
