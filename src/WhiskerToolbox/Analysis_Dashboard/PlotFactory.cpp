...
// Include specific plot widget headers
...
// Include specific properties widget headers
...
std::unique_ptr<PlotContainer> PlotFactory::createPlotContainer(const QString& plot_type)
{
...
std::unique_ptr<AbstractPlotWidget> PlotFactory::createPlotWidget(const QString& plot_type)
{
...
std::unique_ptr<AbstractPlotPropertiesWidget> PlotFactory::createPropertiesWidget(const QString& plot_type)
{
    if (plot_type == "scatter_plot") {
