...
void BinaryAnalogImport_Widget::_onLoadButtonClicked() {
    ...
    options.use_tensor_backed = ui->tensor_backed_checkbox->isChecked();

    // Map combo box index to data type string
    int const dataTypeIndex = ui->data_type_combo->currentIndex();
    switch (dataTypeIndex) {
        case 0:
            options.binary_data_type = "int8";
            break;
        case 1:
            options.binary_data_type = "int16";
            break;
        case 2:
            options.binary_data_type = "uint16";
            break;
        case 3:
            options.binary_data_type = "float32";
            break;
        case 4:
            options.binary_data_type = "float64";
            break;
        default:
            options.binary_data_type = "int16";
            break;
