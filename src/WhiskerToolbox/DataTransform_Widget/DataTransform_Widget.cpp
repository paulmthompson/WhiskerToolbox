...
void DataTransform_Widget::_initializeParameterWidgetFactories() {
    ...
    _parameterWidgetFactories["Mask Cleaning"] = [](QWidget * parent) -> TransformParameter_Widget * {
        return new MaskCleaning_Widget(parent);
    };
    ...
    _parameterWidgetFactories["Line Group to Digital Intervals"] = [this](QWidget * parent) -> TransformParameter_Widget * {
        auto widget = new LineGroupToIntervals_Widget(parent);
        widget->setDataManager(_data_manager);
        return widget;
    };
