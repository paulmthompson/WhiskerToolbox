...
// DISABLED:     ui->tableView->setModel(_line_table_model);
...
// DISABLED:     connect(ui->tableView, &QTableView::doubleClicked, this, &Line_Widget::_handleCellDoubleClicked);
// DISABLED:     connect(ui->tableView, &QTableView::customContextMenuRequested, this, &Line_Widget::_showContextMenu);
