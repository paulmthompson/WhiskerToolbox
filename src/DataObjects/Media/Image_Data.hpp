#ifndef NEURALYZER_IMAGE_DATA_HPP
#define NEURALYZER_IMAGE_DATA_HPP
...
public:
    ...
    MediaType getMediaType() const override { return MediaType::Images; }
...
#endif//NEURALYZER_IMAGE_DATA_HPP
