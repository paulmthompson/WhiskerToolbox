...
struct ValidationResult {
    /** @brief True if no fatal errors were found. */
    bool valid = true;

    /**
     * @brief Non-fatal issues (e.g., data keys not yet present in DataManager).
     */
    std::vector<std::string> warnings;

    /**
     * @brief Fatal issues that would cause execution failure.
     */
 ...
 * @return Variable names for each ${...} pattern found in @p input.
 */
