...
struct SegmentComp { // for sorting edges in the sweep line (sl)
	bool operator() (SweepEvent* le1, SweepEvent* le2) const;
};
...
struct SweepEventComp { // for sorting sweep events
