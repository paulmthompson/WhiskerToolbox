...
TEST_CASE("Data Transform: Mask Hole Filling - JSON pipeline", "[transforms][mask_hole_filling][json]") {
    ...
    test_mask->addAtTime(TimeFrameIndex(0), hollow_rect);
    ...
    test_mask_multi->addAtTime(TimeFrameIndex(0), hollow_rect_small);
    ...
    test_mask_multi->addAtTime(TimeFrameIndex(0), solid_square);
