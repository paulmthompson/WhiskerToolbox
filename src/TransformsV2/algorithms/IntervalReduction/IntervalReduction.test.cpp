...
TEST_CASE("V2 IntervalReductionParams - JSON Rejection",
          "[transforms][v2][params][json][interval_reduction]") {
    ...
    SECTION("Reject malformed JSON") {
        ...
        REQUIRE_FALSE(loadParametersFromJson<IntervalReductionParams>(json));
    }

    SECTION("Reject non-string reduction_name") {
        std::string const json = R"({"reduction_name": 1})";
        REQUIRE_FALSE(loadParametersFromJson<IntervalReductionParams>(json));
    }

    SECTION("Reject non-string column_name") {
        std::string const json = R"({"column_name": true})";
        REQUIRE_FALSE(loadParametersFromJson<IntervalReductionParams>(json));
    }

    SECTION("Reject non-string reduction_params_json") {
        std::string const json = R"({"reduction_params_json": []})";
        REQUIRE_FALSE(loadParametersFromJson<IntervalReductionParams>(json));
    }
}
...
TEST_CASE("V2 IntervalReduction: JSON Pipeline Execution",
    ...
    SECTION("AnalogIntervalReduction via DataManagerPipelineExecutor") {
        ...
        nlohmann::json const pipeline_json = {
                {"steps", {{{"step_id", "reduce_step"}, {"transform_name", "AnalogIntervalReduction"}, {"input_key", "trial_intervals"}, {"additional_input_keys", {"analog_signal"}}, {"output_key", "reduced_tensor"}, {"parameters", {{"reduction_name", "MeanValue"}, {"column_name", "mean_value"}}}}}}};
    ...
    SECTION("EventIntervalReduction via DataManagerPipelineExecutor") {
        ...
        nlohmann::json const pipeline_json = {
                {"steps", {{{"step_id", "count_step"}, {"transform_name", "EventIntervalReduction"}, {"input_key", "intervals"}, {"additional_input_keys", {"events"}}, {"output_key", "event_counts"}, {"parameters", {{"reduction_name", "EventCount"}, {"column_name", "count"}}}}}}};
    ...
    SECTION("IntervalOverlapReduction via DataManagerPipelineExecutor") {
        ...
        nlohmann::json const pipeline_json = {
                {"steps", {{{"step_id", "overlap_step"}, {"transform_name", "IntervalOverlapReduction"}, {"input_key", "row_intervals"}, {"additional_input_keys", {"source_intervals"}}, {"output_key", "overlap_counts"}, {"parameters", {{"reduction_name", "IntervalCount"}, {"column_name", "overlaps"}}}}}}};
...
for (int i = 0; i < 200; ++i) {
        ...
        nlohmann::json const pipeline_json = {
                {"steps", {{{"step_id", "cross_tf_reduce"}, {"transform_name", "AnalogIntervalReduction"}, {"input_key", "trial_intervals"}, {"additional_input_keys", {"analog_signal"}}, {"output_key", "reduced_tensor"}, {"parameters", {{"reduction_name", "MeanValue"}, {"column_name", "cross_tf_mean"}}}}}}};
